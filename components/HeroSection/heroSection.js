    ...
    <div className={`${styles.mainContainer}`}>
      ...
      <div className={`pageContainer ${styles.container}`}>
        <div className={`${styles.heroContentText}`}>
            <div className={`${styles.title}`}>CanCureMeds</div>
            <div className={`${styles.subTitle}`}><Type /></div>
            <div className={`${styles.subTitle}`}>CanCureMeds is your one-stop shop for all things related to medicinal plants in India that have potential to fight cancer! This resource is packed with information about these plants, what medicinal properties they have, and how they might be used in cancer treatments. Whether you&apos;re a researcher, doctor, or just curious about plant-based options for cancer care, CanCureMeds can be your guide.</div>
